 ...
 <section class="content">
   ...
   <div class="row">
        ...
        <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" action="{{ route('admin.offres.store') }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="type_sejour" required>
                        <option>AI</option>
                        <option>PC</option>
                        <option>DP</option>
                      </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="prix" placeholder="Prix" name="prix" pattern="[0-9]{3,}" required>
                     </div>
                    <div class="form-group">
